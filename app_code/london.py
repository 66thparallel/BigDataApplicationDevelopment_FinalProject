...
londonDF = temp2DF.filter((temp2DF.rating != '20') & (temp2DF.rating != '30') & (temp2DF.rating != '40'))
#londonDF = temp3DF.withColumn("rating", when(temp3DF["rating"] == "50", 0.0).otherwise(1.0))
