...
Description: This application uses sentiment analysis to create a ranked list of the best offbeat tourist
    attractions for London, UK for travel industry professionals. For the training and validation data
    we used user reviews for Paris and NYC. Next, we took data from tourist attractions ranked #11 - 30 on
...
# build new RDDs with equal numbers of labeled reviews
